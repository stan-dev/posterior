...
mean.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "mean", matrixStats::colMeans2, useNames = FALSE, .ordered_okay = FALSE, ...)
}
...
median.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "median", matrixStats::colMedians, useNames = FALSE, ...)
}

#' @rdname rvar-summaries-over-draws
#' @export
min.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "min", matrixStats::colMins, useNames = FALSE, ...)
}

#' @rdname rvar-summaries-over-draws
#' @export
max.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "max", matrixStats::colMaxs, useNames = FALSE, ...)
}

#' @rdname rvar-summaries-over-draws
#' @export
sum.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "sum", matrixStats::colSums2, useNames = FALSE, .ordered_okay = FALSE, ...)
}

#' @rdname rvar-summaries-over-draws
#' @export
prod.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "prod", matrixStats::colProds, useNames = FALSE, .ordered_okay = FALSE, ...)
}

#' @rdname rvar-summaries-over-draws
#' @export
all.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "all", matrixStats::colAlls, useNames = FALSE, .ordered_okay = FALSE, ...)
}

#' @rdname rvar-summaries-over-draws
#' @export
any.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "any", matrixStats::colAnys, useNames = FALSE, .ordered_okay = FALSE, ...)
}
...
variance.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "variance", matrixStats::colVars, useNames = FALSE, .ordered_okay = FALSE, ...)
}
...
#' @export
sd.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "sd", matrixStats::colSds, useNames = FALSE, .ordered_okay = FALSE, ...)
}
...
#' @export
mad.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "mad", matrixStats::colMads, useNames = FALSE, .ordered_okay = FALSE, ...)
}
#' @rdname rvar-summaries-over-draws
#' @export
...
range.rvar <- function(x, ...) {
  summarise_rvar_by_element_via_matrix(x, "range", function(...) t(matrixStats::colRanges(...)),
...
is.finite.rvar <- function(x) {
  summarise_rvar_by_element_via_matrix(x, "is.finite", function(x) matrixStats::colAlls(is.finite(x), useNames = FALSE), .factor_okay = TRUE)
}

#' @rdname rvar-summaries-over-draws
#' @export
is.infinite.rvar <- function(x) {
  summarise_rvar_by_element_via_matrix(x, "is.inifite", function(x) matrixStats::colAnys(is.infinite(x), useNames = FALSE), .factor_okay = TRUE)
}

#' @rdname rvar-summaries-over-draws
#' @export
is.nan.rvar <- function(x) {
  summarise_rvar_by_element_via_matrix(x, "is.nan", function(x) matrixStats::colAnys(is.nan(x), useNames = FALSE), .factor_okay = TRUE)
}

#' @rdname rvar-summaries-over-draws
#' @export
is.na.rvar <- function(x) {
  summarise_rvar_by_element_via_matrix(x, "is.na", matrixStats::colAnyNAs, useNames = FALSE, .factor_okay = TRUE)
}
