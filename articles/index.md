...
- [The posterior R
  package](https://mc-stan.org/posterior/articles/posterior.md):
...
- [rvar: The Random Variable
  Datatype](https://mc-stan.org/posterior/articles/rvar.md):
...
- [Pareto-khat
  diagnostics](https://mc-stan.org/posterior/articles/pareto_diagnostics.md):
