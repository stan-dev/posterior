...
[`pit()`](https://mc-stan.org/posterior/dev/reference/pit.md) (including
...
[`pit()`](https://mc-stan.org/posterior/dev/reference/pit.md)) and for
GPD fit.

## See also

[`pit()`](https://mc-stan.org/posterior/dev/reference/pit.md) for the
unsmoothed version,
[`pareto_smooth()`](https://mc-stan.org/posterior/dev/reference/pareto_smooth.md)
