...
[`help("draws")`](https://mc-stan.org/posterior/reference/draws.md). All
of the formats are essentially base R object classes and can be used as
...
this case this would result in a `draws_matrix` object either way.
