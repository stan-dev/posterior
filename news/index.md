...
- Extend and export several functions related to the generalized Pareto
  distribution for use in other packages.
  ([\#408](https://github.com/stan-dev/posterior/issues/408))
- Support Pareto PIT functionality via `pareto_pit`.
  ([\#435](https://github.com/stan-dev/posterior/issues/435))
...
- Implement [`pit()`](https://mc-stan.org/posterior/reference/pit.md)
  for draws and rvar objects. LOO-PIT can be computed using `weights`.
...
- Ensure [`rfun()`](https://mc-stan.org/posterior/reference/rfun.md)
...
- Added new
  ...
  subtypes of
  [`rvar()`](https://mc-stan.org/posterior/reference/rvar.md) that work
  analogously to [`factor()`](https://rdrr.io/r/base/factor.html) and
  ...
  [`vignette("rvar")`](https://mc-stan.org/posterior/articles/rvar.md).
- The
...
- Made [`match()`](https://mc-stan.org/posterior/reference/match.md) and
  `%in%` generic and added support for `rvar`s to both functions.
- Added
  [`modal_category()`](https://mc-stan.org/posterior/reference/modal_category.md),
  [`entropy()`](https://mc-stan.org/posterior/reference/entropy.md), and
...
- [`print.rvar()`](https://mc-stan.org/posterior/reference/print.rvar.md)
  ...
  [`help("posterior-package")`](https://mc-stan.org/posterior/reference/posterior-package.md)).
