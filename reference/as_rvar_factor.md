...
(with modified dimensions if `dim` is not `NULL`), possibly adding
...
and
[`rvar_ordered()`](https://mc-stan.org/posterior/reference/rvar_factor.md)
to construct [`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s
directly. See [`rdo()`](https://mc-stan.org/posterior/reference/rdo.md),
