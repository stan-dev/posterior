...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s). Makes
...
For [`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s, has two
modes:

1.  `x` is a matrix-like
    [`rvar`](https://mc-stan.org/posterior/reference/rvar.md): it
...
2.  `x` is a vector-like
    ...
    [`rvar`](https://mc-stan.org/posterior/reference/rvar.md) with `x`
