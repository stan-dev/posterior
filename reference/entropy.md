...
If `x` is an [rvar](https://mc-stan.org/posterior/reference/rvar.md),
returns an array of the same shape as `x`, where each cell is the
normalized Shannon entropy of the draws in the corresponding cell of
`x`.
