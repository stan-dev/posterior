...
[rvar](https://mc-stan.org/posterior/reference/rvar.md)s, returns an
[rvar](https://mc-stan.org/posterior/reference/rvar.md) of the matches.
...
When `x` is an [rvar](https://mc-stan.org/posterior/reference/rvar.md),
...
When `x` is an [rvar](https://mc-stan.org/posterior/reference/rvar.md),
the draws of `x` are matched against `table` using
[`base::match()`](https://rdrr.io/r/base/match.html), and the result is
returned as an [rvar](https://mc-stan.org/posterior/reference/rvar.md).
...
as [rvar](https://mc-stan.org/posterior/reference/rvar.md)s) are
supported.
