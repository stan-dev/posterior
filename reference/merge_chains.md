...
Merge chains of
[`draws`](https://mc-stan.org/posterior/reference/draws.md) objects into
a single chain. Some operations will trigger an automatic merging of
chains, for example, because chains do not match between two objects
