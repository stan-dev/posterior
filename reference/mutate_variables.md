...
[`draws`](https://mc-stan.org/posterior/reference/draws.md) object.
...
- .x:
  ...
  (draws) A [`draws`](https://mc-stan.org/posterior/reference/draws.md)
  object.
...
Returns a [`draws`](https://mc-stan.org/posterior/reference/draws.md)
object of the same format as `.x`, with variables mutated according to
the expressions provided in `...`.
...
[`draws_df`](https://mc-stan.org/posterior/reference/draws_df.md) and
...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) object if it
is not already one using
