...
- x, object:
  ...
  (rvar) The [`rvar`](https://mc-stan.org/posterior/reference/rvar.md)
  to print.
...
- summary:
  ...
  - `"mode_dissent"` displays `mode <dissent>`, and is used
    automatically for
    [`rvar_ordered`](https://mc-stan.org/posterior/reference/rvar_factor.md)s.
...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) objects by
...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) objects under
the hood, which returns a character vector in the mean±sd or median±mad
form.
