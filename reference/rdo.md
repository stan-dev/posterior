...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s, producing a
new [`rvar`](https://mc-stan.org/posterior/reference/rvar.md).
...
- expr:
  ...
  [`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s. The
  expression supports
...
- dim:
  ...
  [`rvar`](https://mc-stan.org/posterior/reference/rvar.md) to be
  ...
  [`rvar`](https://mc-stan.org/posterior/reference/rvar.md), not the
...
draw of the [`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s
it contains, then returns a new
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) representing
the output of those expressions. To identify
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s, `rdo()`
searches the calling environment for any variables named in `expr` for
which [`is_rvar()`](https://mc-stan.org/posterior/reference/is_rvar.md)
evaluates to `TRUE`. If `expr` contains no
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s, then it will
be executed `ndraws` times and an
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) with that many
draws returned.
...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s simply by
...
directly on [`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s
(which should be fast), using
[`rvar_rng()`](https://mc-stan.org/posterior/reference/rvar_rng.md),
and/or using operations directly on the arrays that back the
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md)s (via
[`draws_of()`](https://mc-stan.org/posterior/reference/draws_of.md)).

## See also

Other rfun: [`rfun()`](https://mc-stan.org/posterior/reference/rfun.md),
[`rvar_rng()`](https://mc-stan.org/posterior/reference/rvar_rng.md)
