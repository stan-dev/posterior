...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) and over draws
of each element, producing an array of the same shape as the input
...
- x:
  ...
  (rvar) An [`rvar`](https://mc-stan.org/posterior/reference/rvar.md).
...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md), `x`.
...
[`rvar`](https://mc-stan.org/posterior/reference/rvar.md) is a logical
...
[rvar-summaries-within-draws](https://mc-stan.org/posterior/reference/rvar-summaries-within-draws.md)
for summary functions within draws.
[rvar-dist](https://mc-stan.org/posterior/reference/rvar-dist.md) for
