...
[`rfun()`](https://mc-stan.org/posterior/reference/rfun.md) or
[`rdo()`](https://mc-stan.org/posterior/reference/rdo.md) to translate
your code into code that executes across draws from one or more random
variables and returns a random variable as output. Typically
[`rdo()`](https://mc-stan.org/posterior/reference/rdo.md) offers the
most straightforward translation.

As [`rfun()`](https://mc-stan.org/posterior/reference/rfun.md) and
[`rdo()`](https://mc-stan.org/posterior/reference/rdo.md) incur some
