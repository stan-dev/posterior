...
- test:
  ...
  (logical [`rvar`](https://mc-stan.org/posterior/reference/rvar.md), or
...
- yes:
  ...
  ([`rvar`](https://mc-stan.org/posterior/reference/rvar.md), or
...
common type of `yes` and `no` (as determined by
