...
Subset [`draws`](https://mc-stan.org/posterior/reference/draws.md)
...
*[repairs](https://mc-stan.org/posterior/reference/repair_draws.md)* the
`draws` object before and after subsetting.
