...
[`draws`](https://mc-stan.org/posterior/reference/draws.md) object. The
...
object of the same format as `x`, with variables named as specified.
...
[`rename_variables`](https://mc-stan.org/posterior/reference/rename_variables.md),
[`draws-index`](https://mc-stan.org/posterior/reference/draws-index.md)
