...
* `draws_rvars`: A list of random variable `rvar` objects (see the other
vignette about this data type), one per variable.
...
other methods available for draws objects including the following.
