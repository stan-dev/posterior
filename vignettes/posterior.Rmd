...
the [vignette](rvar.html) dedicated to this new data type for details.
...
All of the methods demonstrated below, as well as other methods in the package,
are all available for every draws format.
